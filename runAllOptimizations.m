...
%% Define constants
bearing_diameter = 4.28;    % in
sun_shaft_diameter = 0.85;  % in

GR_front_target = 6.375;      % dimensionless
GR_rear_target = 8.25;      % dimensionless
...
parfor i=1:num_runs
    [FOPT, X] = runOneOptimization(vlb, vub, bits, bearing_diameter, ...
        sun_shaft_diameter, maxX, GR_front_target, GR_rear_target, numGenerations)
...
feasible_region_rear = [8.125 8.75 8.75 8.125 8.125];
